...
tar_plan(
  ...
  tar_target(
    euforest_gam_biovars_edge_perf,
    edge_performance(
      species,
      repetitions,
      biovars_models
  ...
  AIC_and_AUC_gam_biovars_sblock_diff_to_B = performance_difference_to_B_comparison_boxplot(
    euforest_gam_biovars_sblock_metrics, euforest_gam_biovars_edge_perf,
    palette,
    species_properties
  ),
  ...
  limit_rel_abs_one_spatial_plot_gam_biovars = one_spatial_rel_abs_plot_limited_ensemble(
    katz_ensemble_gam_biovars_predictions,
    base_ensemble_gam_biovars_predictions,
    euforest,
    species,
  ...
  ## Correlation plot
  cor_plot = get_cor_plot(terraclimate_sdm[[1]]$file, terraclimate_biovars[[1]]$file),
  ...
  #### Additional species for in appendix:
  other_species = species[!species %in% c(
    "Acer pseudoplatanus",
    "Quercus pubescens",
    "Abies alba",
    "Picea abies"
  ...
  tar_target(
    other_katz_ensemble_gam_biovars_predictions,
    gam_ensemble(euforest_gam_biovars,
      model = "katz",
      other_species,
      env_files = c(terraclimate_sdm[[1]]$file, terraclimate_biovars[[1]]$file)
    ),
    pattern = map(other_species),
    garbage_collection = T
  ),
  tar_target(
    other_base_ensemble_gam_biovars_predictions,
    gam_ensemble(euforest_gam_biovars,
      model = "base",
      other_species,
      env_files = c(terraclimate_sdm[[1]]$file, terraclimate_biovars[[1]]$file)
  ...
  other_rel_abs_one_spatial_plot_gam_biovars = one_spatial_rel_abs_plot_other_ensemble(
    other_katz_ensemble_gam_biovars_predictions,
    other_base_ensemble_gam_biovars_predictions,
    euforest,
    species,
